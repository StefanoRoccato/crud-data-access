...
| 16 | S_SEQ_EVENTO_CONTRATTO | sSeqEventoContratto | Long | True | False | IN/OUT | ZERO_IF_NOT_NULLABLE_NUMERIC |
...
| 21 | S_COD_REGIME_FISCALE | sCodRegimeFiscale | String | False | False | IN/OUT | NULL_OTHERWISE |
| 22 | S_FLAG_DETRAIBILITA | sFlagDetraibilita | String | False | True | IN/OUT | NULL_OTHERWISE |
| 23 | S_FLAG_RIN_PRESTITI | sFlagRinPrestiti | String | False | False | IN/OUT | NULL_OTHERWISE |
| 24 | S_DATA_PERFEZIONAMENTO | sDataPerfezionamento | java.time.LocalDate | False | True | IN/OUT | NULL_OTHERWISE |
| 25 | S_COD_RAPPORTO | sCodRapporto | String | False | False | IN/OUT | NULL_OTHERWISE |
| 26 | S_COD_STATO_CONTRATTO | sCodStatoContratto | String | False | False | IN/OUT | NULL_OTHERWISE |
| 27 | S_DATA_DECORRENZA | sDataDecorrenza | java.time.LocalDate | False | False | IN/OUT | NULL_OTHERWISE |
| 28 | S_DATA_SCADENZA | sDataScadenza | java.time.LocalDate | False | True | IN/OUT | NULL_OTHERWISE |
| 29 | S_COD_COASSICURAZIONE | sCodCoassicurazione | String | False | False | IN/OUT | NULL_OTHERWISE |
...
| 34 | S_NUM_MESI_RESID_RISC | sNumMesiResidRisc | Integer | True | True | IN/OUT | NULL_OTHERWISE |
| 35 | S_IMP_IMPON_PROVV_TRASF | sImpImponProvvTrasf | java.math.BigDecimal | True | True | IN/OUT | NULL_OTHERWISE |
| 36 | S_CODICE_RAMO | sCodiceRamo | String | False | False | IN/OUT | NULL_OTHERWISE |
| 37 | S_SEQ_CONV | sSeqConv | Long | True | True | IN/OUT | NULL_OTHERWISE |
| 38 | S_SEQ_RAPPORTO | sSeqRapporto | Long | True | False | IN/OUT | ZERO_IF_NOT_NULLABLE_NUMERIC |
| 39 | S_TIPO_INDIVIDUALE | sTipoIndividuale | String | False | False | IN/OUT | NULL_OTHERWISE |
| 40 | S_CODICE_COMPAGNIA_PVG | sCodiceCompagniaPvg | String | False | False | IN/OUT | NULL_OTHERWISE |
| 41 | S_ID_OPERATORE | sIdOperatore | String | False | False | IN/OUT | NULL_OTHERWISE |
| 42 | S_ID_TIMESTAMP_INIZIO_VAL | sIdTimestampInizioVal | Long | True | False | IN/OUT | ZERO_IF_NOT_NULLABLE_NUMERIC |
| 43 | S_ID_FUNZIONE | sIdFunzione | String | False | False | IN/OUT | NULL_OTHERWISE |
| 44 | S_ID_OPERAZIONE | sIdOperazione | String | False | False | IN/OUT | NULL_OTHERWISE |
| 45 | S_ID_STATO_ELAB | sIdStatoElab | String | False | True | IN/OUT | NULL_OTHERWISE |
| 46 | S_ID_LOCK | sIdLock | Long | True | False | IN/OUT | ZERO_IF_NOT_NULLABLE_NUMERIC |
| 47 | S_ID_COMMENTO | sIdCommento | String | False | True | IN/OUT | NULL_OTHERWISE |
| 48 | S_NUM_MESI_PROR | sNumMesiPror | Integer | True | True | IN/OUT | NULL_OTHERWISE |
| 49 | S_DATA_RIPR_PAG_PREMI | sDataRiprPagPremi | java.time.LocalDate | False | True | IN/OUT | NULL_OTHERWISE |
| 50 | S_IMP_PRESTAZ_MAX_FISCV | sImpPrestazMaxFiscv | java.math.BigDecimal | True | True | IN/OUT | NULL_OTHERWISE |
| 51 | S_TIPO_INDIV_LEGALE | sTipoIndivLegale | String | False | False | IN/OUT | NULL_OTHERWISE |
...
| 54 | S_NUM_ANNO_COORTE | sNumAnnoCoorte | Integer | True | True | IN/OUT | NULL_OTHERWISE |
